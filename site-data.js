...
window.SITE_DATA = {
  ...
  studios: {
    et: {
      ...
      plans: [
        { name: "Newborn Plan", price: "¥33,000〜", desc: "生後3週間以内の新生児撮影。花とともに繊細な命を記録します。", tag: "人気No.1" },
        { name: "Birthday Plan", price: "¥38,500〜", desc: "1歳のバースデーフォト。スマッシュケーキも対応。", tag: "" },
        { name: "753 Plan", price: "¥55,000〜", desc: "七五三の晴れ姿を、季節の花飾りとともに。", tag: "" },
        { name: "Family Plan", price: "¥44,000〜", desc: "家族みんなで残す、大切な一瞬のポートレート。", tag: "" },
        { name: "Maternity Plan", price: "¥33,000〜", desc: "新しい命を迎える前の、特別な時間を永遠に。", tag: "" }
      ],
      recruit: {
        heading: "Recruit",
    ...
    nr: {
      ...
      plans: [
        { name: "Newborn Plan", price: "近日公開", desc: "生後3週間以内の新生児撮影。", tag: "" },
        { name: "Birthday Plan", price: "近日公開", desc: "1歳のバースデーフォト。", tag: "" },
        { name: "753 Plan", price: "近日公開", desc: "七五三の晴れ姿を。", tag: "" },
        { name: "Family Plan", price: "近日公開", desc: "家族みんなで残す一瞬のポートレート。", tag: "" },
        { name: "Maternity Plan", price: "近日公開", desc: "特別な時間を永遠に。", tag: "" }
      ],
      recruit: {
        heading: "Recruit",
