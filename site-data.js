...
window.SITE_DATA = {
  ...
  "studios": {
    "et": {
          ...
          "variants": [
            {
              ...
              "price": "¥43,000",
              "duration": "",
              "description": "撮影料（お子様全員分）+ 撮影データ50cut + 衣装2着 / ヘアメイク（土日祝 +¥5,500）",
              "includes": [
                "撮影料（お子様全員分）",
                "編集済みデータ 50カット",
                "衣装2着（1着でも可）",
          ...
          "variants": [
            {
              ...
              "options": [
                ...
                {
                  "name": "et. Movie（約3分 / 撮影日の1週間前までにご予約ください）",
                  "price": "¥28,000"
                }
              ],
              "gallery": [
          ...
          "variants": [
            {
              ...
              "price": "お問い合わせ",
              "duration": "",
              "description": "撮影料 + 撮影データ10cut（USB付き）+ 衣装1着（土日祝 +¥5,500）",
              "includes": [
                "撮影料",
                "編集済みデータ 10カット（USB付き）",
                "衣装1着（レンタルなし・着付け／ヘアセット済みでご来店）"
              ],
              "options": [
                {
                  "name": "5cut データ追加",
      ...
      "goods": {
        "heading": "Goods",
        "body": "想い出を形に残せるオリジナルグッズをご用意しています。単品のほか、お得なセットメニューもございます。\n※価格はすべて税込です。納期は写真決定から約2ヵ月後になります。",
        "items": [
          {
          ...
          },
          {
            ...
            "name": "アルバム",
            "price": "¥17,000〜",
            "desc": "飽きのこないシンプルなデザインと手に取りやすいサイズ感にこだわった一冊。ハードカバー仕様で専用ケース付き、表紙にお名前を入れることもできます。\nハーフレター(21.6×17.0cm) 10P ¥17,000 ／ 20P ¥21,000 ※50cut限定\nレター(28.8×22.4cm) 10P ¥32,000 ／ 20P ¥37,000 ※50cut限定\nオプション：ネーム入り ¥1,000"
          },
          {
