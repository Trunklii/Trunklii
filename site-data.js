  ...
  "studios": {
    "et": {
      ...
      "reservation": {
        ...
        "note": "ご予約後、7営業日以内に確認のお電話を差し上げます。",
        "blocks": [
          {
            "mark": "A",
            "title": "撮影予約について",
            ...
            "notes": [
              ...
              "日程変更・キャンセルは撮影日の3日前のご予約時間まで、予約サイトからお手続きいただけます。",
              "ご予約後、7営業日以内に確認のお電話（050-1751-2601）を差し上げます。（水曜・木曜は定休日をいただいております）",
              "ご予約は1家族様1枠でお願いいたします。",
              "ご不明な点は Instagram DM・LINE でお問い合わせいただけます。",
              {
                "text": "キャンセルポリシー",
      ...
      "qa": {
        ...
        "items": [
          {
            "q": "何歳から何歳までが撮影料の対象になりますか？",
            "a": "撮影料は、1ヶ月のお子さまから18歳までが対象です。<br>なお、生後1ヶ月未満のお子さまの撮影はご遠慮いただいておりますので、ご了承ください。"
          },
          {
            "q": "撮影時間はどれくらいですか？",
          ...
          {
            "q": "ニューボーン撮影はできますか？",
            "a": "申し訳ございませんが、ニューボーン撮影は承っておりません。"
          },
          {
            "q": "ペットと一緒に撮影できますか？",
            "a": "申し訳ございませんが、ペットとの撮影は承っておりません。"
          },
          {
            "q": "Family Plan の撮影枚数を増やすことはできますか？",
            "a": "申し訳ございませんが、Family Plan の撮影枚数を追加することはできません。"
          },
          {
            "q": "衣装は持ち込めますか？",
          ...
          {
            "q": "持ち込みの着物で着付け・撮影はできますか？",
            "a": "はい、可能です。<br>ご来店前に一度お子さまに着物を羽織っていただき、袖の長さが合っているか、肩上げがされているかをご確認ください。<br>また、結び帯のお着物は当店では着付けを承ることができませんので、あらかじめご了承ください。"
          },
          {
            "q": "着物を遠方までレンタルすることはできますか？",
            "a": "申し訳ございませんが、着物の遠方へのレンタルは承っておりません。"
          },
          {
            "q": "カジュアル衣装は何cmまで用意がありますか？",
            "a": "カジュアル衣装は、120cmくらいまでご用意しております。<br>120cmを超えるサイズのお子さまにつきましては、お洋服のお持ち込みをお願いいたします。"
          },
          {
            "q": "日本髪のヘアセットは可能ですか？",
          ...
          {
            "q": "スタジオで用意した生花を髪飾りとして付けてもらうことはできますか？",
            "a": "申し訳ございませんが、スタジオでご用意している生花を髪飾りとして使用することは承っておりません。<br>ご希望の場合は、Art photo coordinate のオプションを追加してください。"
          },
          {
            "q": "生花を持ち込んで髪飾りとして付けてもらうことはできますか？",
            "a": "申し訳ございませんが、生花のお持ち込みはご遠慮いただいております。<br>ご希望の場合は、Art photo coordinate のオプションを追加してください。"
          },
          {
            "q": "造花を持ち込んで、髪飾りや瓶差しのように飾ることはできますか？",
            "a": "髪飾りとして使用する場合は、髪に付けられるピンなどが付いた状態で、2〜3輪程度であれば可能です。<br>ただし、Art photo coordinate の髪飾りと同じようなスタイリングでのご用意はできませんので、あらかじめご了承ください。<br>また、造花を瓶差しのようにセッティングすることはできません。花瓶の貸し出しも行っておりませんので、ご了承ください。"
          },
          {
            "q": "Art photo coordinate のお花は、品種を指定できますか？",
            "a": "お花のお色味についてはご希望をお伺いしております。<br>ただし、お花の仕入れ状況などにより、品種のご指定は承っておりませんので、ご了承ください。"
          },
          {
            "q": "Art photo coordinate で使用したお花は、撮影後に持ち帰ることはできますか？",
            "a": "申し訳ございませんが、撮影後のお花のお持ち帰りはご遠慮いただいております。<br>なお、撮影で使用したお花を他のお客さまの撮影で再利用することはございませんので、ご安心ください。"
          },
          {
            "q": "スマッシュケーキはできますか？",
            "a": "はい、可能です。追加オプションとして ¥5,500 で承っております。<br>ただし、以下の点についてあらかじめご了承ください。<br>・撮影時間は 14:30〜 の撮影枠のみご案内可能です。<br>・スマッシュケーキの撮影時は、お持ち込みのお洋服で撮影いたします。<br>・お持ち込みのお洋服は、衣装1着分としてカウントさせていただきます。<br>・ケーキを保管する場所がないため、保冷バッグをご持参ください。<br>・撮影後に洗い流せる場所がないため、タオルやウェットシートなどを多めにご用意ください。<br><br>【お持ち物】<br>・ケーキ<br>・ケーキを乗せる台またはお皿（撮影でも使用させていただきます）<br>・お洋服<br>・タオル・ウェットシート<br>・レジャーシート<br>・スマッシュケーキの際に床に敷く布<br><br>床に敷く布は、150cm×120cm以上の大きさをご用意ください。布・シーツなど、扱いやすいもので大丈夫です。<br>スタジオの雰囲気に合わせやすいよう、白やベージュ系のお色味がおすすめです。"
          },
          {
            "q": "撮影中に動画を撮影することはできますか？",
            "a": "はい、スマートフォンや携帯電話での動画撮影は可能です。<br>ご家族の思い出として、ぜひ動画もお楽しみください。"
          },
          {
            "q": "一眼レフやミラーレスカメラ、ビデオカメラなどを持ち込んで撮影できますか？",
            "a": "安全面の都合上、一眼レフ・ミラーレスカメラ・ビデオカメラなどのお持ち込みはご遠慮いただいております。<br>撮影中はお客さまやスタッフの出入りがあり、カメラとの接触などによる事故を防ぐため、ご理解とご協力をお願いいたします。"
          },
          {
            "q": "小物は持ち込めますか？",
            "a": "はい、可能です。お子さまのお気に入りのおもちゃや思い出の品など、ぜひお持ち込みください。<br>ただし、生花・なまもの・壊れやすいものにつきましては、安全面や衛生面の都合上、お持ち込みをご遠慮いただいております。"
          },
          {
            "q": "雨天時はどうなりますか？",
          ...
          },
          {
            ...
            "a": "撮影後、フォトグラファーがお写真のセレクトから編集まで行い、当日中にお客さまのスマートフォンへお送りいたします。<br>スムーズにデータをお受け取りいただけるよう、事前にスマートフォンの空き容量を確保していただきますようお願いいたします。<br>アルバムやフォトフレームなどの商品は、後日のお届けとなります。"
          },
          {
            "q": "撮影後、自分で写真を選ぶことはできますか？",
            "a": "当日は数百枚のお写真を撮影するため、フォトグラファーがセレクトしたお写真を納品いたします。<br>お客さまご自身でのお写真選びは承っておりませんので、あらかじめご了承ください。"
          },
          {
            "q": "ギガファイル便でデータを送ってもらったり、持ち込んだUSBにデータを入れてもらったりできますか？",
            "a": "申し訳ございませんが、ギガファイル便でのデータ送信や、お持ち込みいただいたUSBへのデータ保存は承っておりません。<br>USBをご希望の場合は、当店でも ¥3,300 でUSBをご用意しております。ご購入いただいた場合は、そちらに撮影データを入れてお渡しいたします。"
          },
          {
            "q": "撮影当日に商品を購入しなかった場合、後日購入することはできますか？",
            "a": "はい、可能です。後日、オンラインストアからご購入いただけます。<br>ただし、セット商品につきましては撮影当日限定の商品となりますので、あらかじめご了承ください。"
          },
          {
            "q": "事前に衣装やスタジオを見学することはできますか？",
            "a": "はい、可能です。事前のご予約が必要となります。<br>見学は 16:00 または 16:30 の時間帯で承っております。ご希望の場合は、事前にお問い合わせください。"
          },
          {
            "q": "駐車場はありますか？",
    ...
    "nr": {
      ...
      "about": {
        "image": "about-maison-nr-kasugai-03.jpg",
        ...
        "alt": "Maison nr. 店づくりの設計図と素材サンプルを貼った壁"
      },
      "gallery": [
        {
      ...
      "plans": [
        {
          "key": "753",
          "name": "753 Plan",
          "desc": "アンティーク着物レンタルから着付け・ヘアメイク・撮影まで。手ぶらでお越しいただける七五三の記念撮影プラン。",
          "tag": "40CUT - 撮影料金＋プラン",
          "detail": {
            "heroImage": "plan-753-maison-nr-kasugai-02.jpg",
            "tagline": "七五三の晴れ姿を、生花とともに。",
            "longDescription": "アンティーク着物のレンタルから着付け・ヘアメイク・撮影まで含んだ、手ぶらでお越しいただける七五三の記念撮影プランです。\nご料金は「撮影料金（お子様の年齢・性別）＋ プラン（生花髪飾り／空間装飾／両方）」の合計です。\n撮影データは40枚、ソロ写真とご家族写真の両方をお撮りします。",
            "notes": "※「撮影料金 ＋ プラン」の合計金額となります。オプションは別途となります。\n※所要時間は 2時間30分〜3時間 です。\n※土日祝は +¥5,500 となります。\n※ハイシーズン（10月〜12月）は全日 +¥5,500 となります（土日祝はさらに +¥5,500 で合計 +¥11,000）。\n※パパママ着物、ごきょうだいのお支度料は追加オプションとなります。\n※きょうだいオプションは＋10cut の追加撮影です。いずれもソロ撮影／きょうだい写真を含みます。\n※生花はスタジオでご用意するため、お持ち込みはご遠慮いただいております。\n※オプションでカット数を追加した場合の合計は、メイン撮影のお子様が1人の場合は最大50cut、2人以上の場合は最大70cutまで撮影可能です。\n※表示価格はすべて税込です。"
          },
          "variants": [
            {
              "cuts": 40,
              "label": "【 蕾 】生花髪飾り／3・5歳 男の子",
              "price": "¥60,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥10,000（3・5歳 男の子）＋ 生花髪飾り ¥50,000 ＝ ¥60,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
                "ヘアメイク",
                "生花髪飾り or 手持ちフラワー（当日コーディネートさせていただきます）"
              ],
              "options": [
                {
                  "name": "髪飾りイメージオーダー",
                ...
                {
                  "name": "2style +10cut追加（カジュアル衣装のみ）",
                  "price": "¥11,000"
                },
                {
                  "name": "きょうだい撮影 3歳・5歳 男の子着物",
                  "price": "¥10,000"
                },
                {
                  "name": "きょうだい撮影 3歳 女の子着物",
                  "price": "¥13,000"
                },
                {
                  "name": "きょうだい撮影 7歳 女の子着物",
                  "price": "¥15,000"
                },
                {
                  "name": "カジュアル衣装（きょうだい・家族撮影のみ）",
                  "price": "¥3,300"
                },
                {
                  "name": "カジュアル衣装（ソロ撮影も希望 / +10cut追加）",
                  "price": "¥11,000"
                },
                {
                  "name": "ママ 着付け＋和装ヘアセット（持込着物）",
                  "price": "¥17,000"
                },
                {
                  "name": "ママ 着付けのみ（持込着物）",
            ...
            {
              "cuts": 40,
              "label": "【 蕾 】生花髪飾り／3歳 女の子",
              "price": "¥63,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥13,000（3歳 女の子）＋ 生花髪飾り ¥50,000 ＝ ¥63,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            {
              "cuts": 40,
              "label": "【 蕾 】生花髪飾り／7歳 女の子",
              "price": "¥65,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥15,000（7歳 女の子）＋ 生花髪飾り ¥50,000 ＝ ¥65,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            {
              "cuts": 40,
              "label": "【 華 】空間装飾／3・5歳 男の子",
              "price": "¥83,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥10,000（3・5歳 男の子）＋ 空間装飾 ¥73,000 ＝ ¥83,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            },
            {
              ...
              "price": "¥86,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥13,000（3歳 女の子）＋ 空間装飾 ¥73,000 ＝ ¥86,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            },
            {
              ...
              "price": "¥88,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥15,000（7歳 女の子）＋ 空間装飾 ¥73,000 ＝ ¥88,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            {
              "cuts": 40,
              "label": "【 雅 】生花髪飾り ＋ 空間装飾／3・5歳 男の子",
              "price": "¥95,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥10,000（3・5歳 男の子）＋ 生花髪飾り ＋ 空間装飾 ¥85,000 ＝ ¥95,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            {
              "cuts": 40,
              "label": "【 雅 】生花髪飾り ＋ 空間装飾／3歳 女の子",
              "price": "¥98,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥13,000（3歳 女の子）＋ 生花髪飾り ＋ 空間装飾 ¥85,000 ＝ ¥98,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
            ...
            {
              "cuts": 40,
              "label": "【 雅 】生花髪飾り ＋ 空間装飾／7歳 女の子",
              "price": "¥100,000",
              "duration": "2時間30分〜3時間",
              "description": "撮影料金 ¥15,000（7歳 女の子）＋ 生花髪飾り ＋ 空間装飾 ¥85,000 ＝ ¥100,000（土日祝 +¥5,500 / ハイシーズン10〜12月 全日 +¥5,500）",
              "includes": [
                "編集済みデータ 40枚",
                "ソロ写真 / 家族写真",
                "着物 1着",
        ...
        },
        {
          "key": "birthday",
          "name": "Baby & Kids",
          "desc": "1歳のスマッシュケーキ、お誕生日、入園・入学。季節の生花とともに、その年の姿を残す記念撮影プラン。",
          "tag": "",
          "detail": {
            "heroImage": "plan-birthday-maison-nr-kasugai-02.jpg",
            "tagline": "その年のいちばんを、生花とともに。",
            "longDescription": "1歳のお誕生日はスマッシュケーキ、それ以降のお誕生日や入園・入学はカジュアルで。ソロ写真とご家族写真、季節の生花（5本）が含まれます。\n",
            "notes": "※土日祝は +¥5,500 となります。ハイシーズンの加算はありません。\n※所要時間は 2時間30分〜3時間 です。\n※オプションでカット数を追加した場合の合計は、メイン撮影のお子様が1人の場合は最大40cut、2人以上の場合は最大60cutまで撮影可能です。\n※表示価格はすべて税込です。"
          },
          "variants": [
            {
              "cuts": 30,
              "label": "SMASH CAKE（1st Birthday）",
              "price": "¥42,000",
              "duration": "2時間30分〜3時間",
              "description": "SMASH CAKE ¥42,000（土日祝 +¥5,500 / ハイシーズンの加算はありません）",
              "includes": [
                "編集済みデータ 30枚",
                "ソロ写真 / 家族写真",
                "スマッシュケーキ（持込のみ）",
                "衣装 2着（レンタル衣装1着＋おむつ or 持込衣装1着）",
                "ヘアメイク（できるお子様）",
                "季節の生花（5本）"
              ],
              "options": [
            ...
            {
              "cuts": 30,
              "label": "CASUAL（Birthday / 入園・入学）",
              "price": "¥39,000",
              "duration": "2時間30分〜3時間",
              "description": "CASUAL ¥39,000（土日祝 +¥5,500 / ハイシーズンの加算はありません）",
              "includes": [
                "編集済みデータ 30枚",
                "ソロ写真 / 家族写真",
                "衣装 1着",
        ...
        },
        {
          ...
          "cardImage": "plan-coming-soon-maison-nr-kasugai-03.jpg",
          "tag": "",
          "detail": null,
          "variants": []
        }
      ...
      "calendar": {
        "heading": "Calendar",
        "body": "料金カレンダーは2026年10月1日に公開予定です。\n撮影料金・空き状況は、ご予約ページよりご確認ください。",
        "embedUrl": "",
        "note": "※定休日：火曜・水曜 / ※年末年始（12/28〜1/4）は休業いたします。 / ※撮影は完全予約制です。"
      },
      "reservation": {
        "heading": "Reservation",
      ...
      "cancelPolicy": {
        ...
        "note": "予約サイトでの日程変更・キャンセルは、撮影日の3日前のご予約時間までです。お客様都合のキャンセル（体調不良を含む）は、理由を問わずキャンセル料金の対象となります。"
      },
      "qa": {
        "heading": "Q & A",
      ...
      "flow": {
        ...
        "steps": [
          {
            "title": "撮影プランと日時を選ぶ",
            "desc": "ご予約ページで、撮影プラン・ご希望の日時・お客様情報を順にお選びいただきます。空いている枠だけが表示されます。",
            "note": ""
          },
          {
            "title": "LINEで予約を確定する",
            "desc": "入力後の画面からLINEを開き、ボタンを押すだけで確定します。メッセージを送る操作はいりません。",
            "note": "LINEの友だち追加が必要です"
          },
          {
            "title": "確定のご案内が届く",
            "desc": "LINEのトークとメールに、確定のご案内をお送りします。この時点でお席が確保されます。",
            "note": ""
          },
          {
            "title": "撮影アンケートにご回答",
            "desc": "確定のご案内と一緒に、撮影アンケートをお送りします。お子様の人数やご希望のイメージを伺うもので、2〜3分で終わります。ご回答がないと、当日のご準備が整いません。",
            "note": "後日ではなく、ご案内が届いたその場でご回答ください",
            "urgent": true
          },
          {
            "title": "事前の電話カウンセリング",
            "desc": "お電話で、撮影内容・衣装・ご希望のイメージを伺います。",
            "note": "ご予約から7営業日以内"
          },
          {
            "title": "当日撮影・当日データ納品",
            "desc": "撮影後はその場で編集し、撮影当日にデータをお渡しします。スマホの空き容量をご用意のうえお越しください。",
            "note": "アルバム・フォトフレームなどは後日納品"
          }
        ]
      },
      "recruit": {
      ...
      "menuSheets": [
        {
          "key": "753",
          "eyebrow": "SHICHI-GO-SAN · 2026",
          "title": "七五三 撮影メニュー",
          "lead": "ご料金は <b>撮影料金</b> ＋ <b>プラン</b> ＋ <b>オプション（任意）</b> の合計です。",
          "steps": [
            {
              "no": "①",
              "req": true,
            ...
            },
            {
              ...
              "items": [
                ...
                },
                {
                  ...
                  "note": "LINEにて事前打ち合わせがあります"
                },
                {
                  "name": "【 雅 】生花髪飾り ＋ 空間装飾",
                  "en": "MIYABI · HAIR ORNAMENT + SPACE DECORATION",
                  "price": 85000,
                  "includes": [
                    "データ 40枚",
                    "ソロ / 家族写真",
                ...
                },
                {
                  ...
                  "rows": [
                    ...
                    },
                    {
                      "name": "カジュアル衣装",
                      "price": "¥3,300",
                      "sub": "きょうだい・家族撮影のみ希望の場合"
                    },
                    {
                      "name": "カジュアル衣装",
                      "price": "¥11,000",
                      "sub": "ソロ撮影も希望の場合 / +10cut追加"
                    }
                  ],
                  "note": "着物のオプションは +10cut の追加撮影です（ソロ撮影 / きょうだい撮影 が可能）。カジュアル衣装は ¥11,000 の場合のみ +10cut の追加撮影となります。"
                },
                {
                  "title": "大人着物オプション",
                  "en": "FOR PARENTS",
          ...
          "surcharge": {
            "weekendLabel": "土日祝は",
            "weekend": "+¥5,500",
            "footer": "ハイシーズン（10月〜12月）は全日 +¥5,500"
          },
          "notes": [
            "例：3歳 男の子／生花髪飾り／10月の平日 ＝ ¥10,000 ＋ ¥50,000 ＋ ¥5,500 ＝ ¥65,500。7歳 女の子／生花髪飾り＋空間装飾／10月の土曜 ＝ ¥15,000 ＋ ¥85,000 ＋ ¥11,000 ＝ ¥111,000。",
            "所要時間は 2時間30分〜3時間 です。",
            "全てのプランに生花がついています。",
            "ごきょうだいのお支度料は追加オプションとなります。",
            "オプションでカット数を追加した場合の合計は、メイン撮影のお子様が1人の場合は最大50cut、2人以上の場合は最大70cutまで撮影可能です。",
            "生花はこちらでご用意するため、お持ち込みはご遠慮いただいております。"
          ]
        },
        {
          "key": "birthday",
          "eyebrow": "SMASH CAKE / CASUAL · 2026",
          "title": "Baby & Kids 撮影メニュー",
          "lead": "ご料金は <b>撮影料金</b> ＋ <b>オプション（任意）</b> の合計です。",
          "steps": [
            {
              "no": "①",
              "req": true,
              ...
              "items": [
                {
                  ...
                  "note": "衣装はレンタル衣装1着＋おむつ or 持込衣装1着（スマッシュケーキ用）"
                },
                {
                  "name": "CASUAL",
                  "en": "BIRTHDAY / 入園・入学",
          ...
          "notes": [
            "例：CASUAL／10月の土曜 ＝ ¥39,000 ＋ ¥5,500 ＝ ¥44,500。SMASH CAKE／平日 ＝ ¥42,000。",
            "所要時間は 2時間30分〜3時間 です。",
            "ハイシーズン（10月〜12月）の加算はありません。",
            "全てのプランに生花がついています。季節の生花は撮影アイテムとしてお子様の周りに置いたり手に持って使います。",
            "ごきょうだいのお支度料は追加オプションとなります。",
            "オプションでカット数を追加した場合の合計は、メイン撮影のお子様が1人の場合は最大40cut、2人以上の場合は最大60cutまで撮影可能です。"
          ]
        }
